...
* OpenCV (tested with v4.8.1; for fast landmark detection, we strongly advise to [compile OpenCV with CUDA](https://github.com/Computational-Psychiatry/3DI/wiki/Compiling-OpenCV-with-CUDA-12.x))
* Python 3
